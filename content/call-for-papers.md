...
description: "Submit your research papers to ICCoSD-26. Topics include communication systems, smart devices, IoT, 5G, and more."
...
noticeBody: "**Paper submission deadline: To be announced (currently open)** – ICCoSD-26 is currently accepting submissions. Updated timelines will be shared soon."
generalGuidelines: |
  - Papers should present original, unpublished work in any of the conference topics.
...
acceptedPapers: |
  Accepted papers will be included in the conference proceedings and considered for publication in IEEE Xplore Digital Library (if papers meet IEEE quality standards).
...
authorGuidelines: |
  - Use the IEEE manuscript template for conference proceedings.
